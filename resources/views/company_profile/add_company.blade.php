            ...
            <div class="card card-dark">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter website" name="website">
                  </div>
                  ...
                  <div class="form-group"> 
                                            ...
                                            <textarea class="form-control" rows="3" name="details" placeholder="Enter Description..."></textarea>
                                        </div>
